...
const TelaConfirmacao = ({ handleRepostas, dispatch, respostas }) => {
  ...
  useEffect(() => {
    ...
    respostas.questao1.pontuacaoPertencimento,
    respostas.questao1.pontuacaoVulnerabilidadeSocioeconomica,
    respostas.questao3.pontuacaoExperienciaTrabalho,
    respostas.questao3.pontuacaoMembroComunidade,
    respostas.questao4.pontuacaoEntendimentoBeneficiosRetorno,
    respostas.questao4.pontuacaoEntendimentoProfissional,
  ]);
  ...
  return (
    <ScrollView w="100%">
      <AlertDialog isOpen={caixaDialogoAberta}>
        <AlertDialog.Content>
          <AlertDialog.Header>Entrevista salva com sucesso</AlertDialog.Header>

          <AlertDialog.Body>Você deseja cadastra uma nova entrevista?</AlertDialog.Body>

          <AlertDialog.Footer>
            <Button variant="unstyled" onPress={() => navigation.navigate('Lista de Entrevistas')}>
              Não
            </Button>

            <Button onPress={() => dispatch({ type: 'resetar' })}>Sim</Button>
          </AlertDialog.Footer>
        </AlertDialog.Content>
      </AlertDialog>
      ...
      <Box padding={2}>
        ...
        >
          ...
          <VStack backgroundColor="white" padding={3} borderRadius={10} shadow="3">
        ...
        <VStack space={6} marginBottom={8}>
          ...
          >
            ...
            <Box padding={4} borderRadius={10} background="gray.700">
          ...
          >
            <Text flex={1} fontSize="xl" fontWeight="semibold" color="gray.500">
              3. Experiência de Trabalho e de Participação em Atividades Junto à Comunidade
              Tradicional.
            </Text>
            <Box padding={4} borderRadius={10} background="gray.700">
              <Text fontSize="4xl" fontWeight="semibold" color="white">
