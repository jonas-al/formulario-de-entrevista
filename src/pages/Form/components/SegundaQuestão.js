    ...
    <ScrollView w='95%'>
        ...
        <VStack space={6} marginBottom={8}>
          <FormControl isInvalid={errors.localEnsinoMedio}>
            <FormControl.Label>
              Onde e como fez o Ensino Médio?
            </FormControl.Label>
            <Controller
              ...
              render={({ field: { onChange, onBlur, value } }) => (
                <Box>
                  ...
                  <Radio.Group
                    onChange={(value) => {
                      onChange(value)
                      setSelectSofreuDescriminacao(value)
                    }}
                    value={value || ''}
                  >
          ...
          <FormControl isInvalid={errors.pontuacaoDificuldades}>
            <FormControl.Label flexDirection='colum'>
              a) Dificuldades enfrentadas no percurso escolar. Analisar considerando o Histórico Escolar do Ensino Médio. 
          ...
          <FormControl isInvalid={errors.pontuacaoVunerabilidade}>
            <FormControl.Label flexDirection='colum'>
              b) Dificuldades e presença de discriminações que agravem sua situação de vulnerabilidade.
