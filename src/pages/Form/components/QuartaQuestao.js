    ...
    <ScrollView w="95%">
      ...
      <VStack space={6} marginBottom={8}>
        ...
        <FormControl isInvalid={errors.primeiraOpcaoCurso}>
          <FormControl.Label>O curso escolhido foi sua primeira opção?</FormControl.Label>
          <Controller
        ...
        <FormControl isInvalid={errors.conhecimentoProfissaoEscolhida}>
          <FormControl.Label>
            O que você sabe sobre a profissão escolhida em termos de área de atuação, mercado de
            trabalho?
          </FormControl.Label>
          <Controller
        ...
        <FormControl isInvalid={errors.beneficioOferecidoAComunidade}>
          <FormControl.Label>
            Qual benefício / retorno poderá ser oferecido ao seu povo ou à comunidade tradicional a
            que você pertence?
          </FormControl.Label>
          <Controller
        ...
        <FormControl isInvalid={errors.pontuacaoEntendimentoProfissional}>
          <FormControl.Label flexDirection="colum">
            a) Entendimento da relação entre sua escolha profissional e a as suas motivações,
            interesses pessoais e coletivos para indicação ao curso.
        ...
        <FormControl isInvalid={errors.pontuacaoEntendimentoBeneficiosRetorno}>
          <FormControl.Label flexDirection="colum">
            b) Entendimento quanto aos benefícios/retorno a serem oportunizados aos povos e às
